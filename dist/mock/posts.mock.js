...
export function generateMockPost(platform) {
    const contentText = postContents[randomInt(0, postContents.length - 1)];
    const platformPostId = platform + "_post_" + randomInt(1000, 9999);
    const postType = postTypes[platform] || "POST";
    const publishedAt = new Date(Date.now() - randomInt(0, 30) * 24 * 60 * 60 * 1000);
    return {
        contentText,
        platformPostId,
        postType,
...
//# sourceMappingURL=posts.mock.js.map